...
namespace FlounderSharp
{
    public unsafe partial class MeshTerrain : global::FlounderSharp.MeshSimple, IDisposable
    {
        ...
        public MeshTerrain(ref float sideLength, ref float squareSize, ref int vertexCount, ref float textureScale, ref float radius, global::FlounderSharp.Transform transform)
            : this((void*) null)
        {
                ...
                fixed (float* __refParamPtr1 = &squareSize)
                {
                    ...
                    fixed (int* __refParamPtr2 = &vertexCount)
                    {
                        ...
                        fixed (float* __refParamPtr3 = &textureScale)
                        {
                            ...
                            fixed (float* __refParamPtr4 = &radius)
                            {
        ...
        public static int SIDE_LENGTH
        {
            get
            {
                var __ptr = (int*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?SIDE_LENGTH@MeshTerrain@fl@@2HB");
                return *__ptr;
            }
        }
