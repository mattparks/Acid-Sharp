...
namespace FlounderSharp
{
    public unsafe partial class MeshPattern : global::FlounderSharp.Model, IDisposable
    {
        ...
        public MeshPattern(ref float sideLength, ref float squareSize, ref int vertexCount, ref float textureScale)
            : this((void*) null)
        {
        ...
        protected virtual global::FlounderSharp.Vector3 GetPosition(ref float x, ref float z)
        {
