...
namespace FlounderSharp
{
    public unsafe partial class ShapeSphere : global::FlounderSharp.Model, IDisposable
    {
        ...
        public ShapeSphere(ref uint latitudeBands, ref uint longitudeBands, ref float radius)
            : this((void*) null)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(global::FlounderSharp.ShapeSphere.__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
            fixed (uint* __refParamPtr0 = &latitudeBands)
            {
                var __arg0 = __refParamPtr0;
                fixed (uint* __refParamPtr1 = &longitudeBands)
                {
                    var __arg1 = __refParamPtr1;
                    fixed (float* __refParamPtr2 = &radius)
                    {
        ...
        public static global::FlounderSharp.ShapeSphere Resource(ref uint latitudeBands, ref uint longitudeBands, ref float radius)
        {
            fixed (uint* __refParamPtr0 = &latitudeBands)
            {
                var __arg0 = __refParamPtr0;
