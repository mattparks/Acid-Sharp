...
namespace FlounderSharp
{
    public unsafe partial class MeshWater : global::FlounderSharp.MeshSimple, IDisposable
    {
        ...
        public override global::FlounderSharp.Vector3 GetPosition(ref float x, ref float z)
        {
            return base.GetPosition(ref x, ref z);
        }
        ...
        public static float SIDE_LENGTH
        {
            get
            {
                var __ptr = (float*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?SIDE_LENGTH@MeshWater@fl@@2MB");
                return *__ptr;
            }
        }
        ...
        public static float SQUARE_SIZE
        {
            get
            {
                var __ptr = (float*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?SQUARE_SIZE@MeshWater@fl@@2MB");
                return *__ptr;
            }
        }
        ...
        public static int VERTEX_COUNT
        {
            get
            {
                var __ptr = (int*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?VERTEX_COUNT@MeshWater@fl@@2HB");
                return *__ptr;
            }
        }
        ...
        public static float TEXTURE_SCALE
        {
            get
            {
                var __ptr = (float*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?TEXTURE_SCALE@MeshWater@fl@@2MB");
                return *__ptr;
            }
        }

        public static global::FlounderSharp.Colour WATER_COLOUR
        {
            get
            {
                var __ptr = (global::FlounderSharp.Colour.__Internal*)CppSharp.SymbolResolver.ResolveSymbol("Flounder", "_imp_?WATER_COLOUR@MeshWater@fl@@2VColour@2@B");
