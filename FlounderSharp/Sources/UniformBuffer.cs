...
namespace FlounderSharp
{
    public unsafe partial class UniformBuffer : global::FlounderSharp.Buffer, global::FlounderSharp.IIDescriptor, IDisposable
    {
        ...
        public UniformBuffer(ref ulong size)
            : this((void*) null)
        {
        ...
        {
            var __slot = *(void**) ((IntPtr) __OriginalVTables[1] + 2 * 8);
            ...
            fixed (uint* __refParamPtr0 = &binding)
            {
                ...
                ___GetWriteDescriptorDelegate((__Instance + 32), new IntPtr(&__ret), __arg0, __arg1);
        ...
        {
            return new global::FlounderSharp.UniformBuffer(ref *size);
        }
