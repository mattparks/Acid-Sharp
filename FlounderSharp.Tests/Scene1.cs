...
namespace FlounderSharp.Tests
{
    class Scene1 : Scene
    {
		...
		{
			// Skybox.
			var skyboxObject = new GameObject(new Transform(new Vector3(), new Vector3(), 2048.0f), null, "SkyboxChapel");
			...
			// Entities.
			var sun = new GameObject(new Transform(new Vector3(100.0f, 1000.0f, 8000.0f), new Vector3(), 18.0f), null, "Sun");
